"""
SDK retrieval evaluation for MemoryBench Progressive Search.
=============================================================
Usage:
...
from progressive_search_eval import (
    ...
    ProgressiveSearchSDKEval,
)


def main() -> None:
    parser = argparse.ArgumentParser(description="MemoryBench Progressive Search SDK evaluation")
