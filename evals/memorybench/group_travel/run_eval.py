"""
SDK retrieval evaluation for MemoryBench Group Travel Planner.
===============================================================
Usage:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="MemoryBench Group Travel Planner SDK evaluation")
    ...
    print("=" * 70, flush=True)
    print("MemoryBench Group Travel Planner — SDK Evaluation", flush=True)
